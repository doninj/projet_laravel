                                ...
                                @foreach(Cart::content() as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-0 align-middle">
                                            <strong>{{ $product->model->getFrenchPrice() }}</strong></td>
                                        <td class="border-0 align-middle"><strong>{{ $product->qty }}</strong></td>
                                        <td class="border-0 align-middle">
                                            <form action="{{ route('cart.destroy',$product->rowId) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-dark"> <a href="#" class="text-dark"><i
                    ...
                    <div class="p-4">
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                    class="text-muted">Order Subtotal </strong><strong>{{ getPrice(Cart::subtotal())}}</strong></li>
